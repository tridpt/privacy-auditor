...
const TRACKERS = {
  ...
  // ── Analytics (modern / privacy-washed) ──────────────────
  'plausible.io':             { name: 'Plausible',               category: 'Analytics',             risk: 'low',      desc: 'Privacy-focused, cookieless analytics' },
  'static.cloudflareinsights.com': { name: 'Cloudflare Insights', category: 'Analytics',           risk: 'low',      desc: 'Cloudflare privacy-first web analytics' },
  'matomo.cloud':             { name: 'Matomo',                  category: 'Analytics',             risk: 'low',      desc: 'Open-source, self-hostable analytics' },
  'stats.wp.com':             { name: 'WordPress Stats (Jetpack)', category: 'Analytics',           risk: 'medium',   desc: 'Automattic/Jetpack site statistics' },
  'fathom.com':               { name: 'Fathom Analytics',        category: 'Analytics',             risk: 'low',      desc: 'Privacy-first, cookieless analytics' },
  'cdn.amplitude.com':        { name: 'Amplitude CDN',           category: 'Analytics',             risk: 'medium'   },
  'analytics.google.com':     { name: 'Google Analytics 4',      category: 'Analytics',             risk: 'medium',   desc: 'GA4 measurement endpoint' },
  'region1.google-analytics.com': { name: 'Google Analytics 4', category: 'Analytics',             risk: 'medium',   desc: 'GA4 regional collection endpoint' },
  'analytics.twitter.com':    { name: 'Twitter/X Analytics',     category: 'Analytics',             risk: 'medium'   },

  // ── Advertising (additional networks) ────────────────────
  'adform.net':               { name: 'Adform',                  category: 'Advertising',           risk: 'high',     desc: 'Programmatic ad platform with cross-site tracking' },
  'teads.tv':                 { name: 'Teads',                   category: 'Advertising',           risk: 'high',     desc: 'Outstream video advertising network' },
  'criteo.net':               { name: 'Criteo',                  category: 'Advertising',           risk: 'high'   },
  'yieldmo.com':              { name: 'Yieldmo',                 category: 'Advertising',           risk: 'high',     desc: 'Mobile-focused ad exchange' },
  'gumgum.com':               { name: 'GumGum',                  category: 'Advertising',           risk: 'high',     desc: 'Contextual in-image and in-screen advertising' },
  'districtm.io':             { name: 'District M',              category: 'Advertising',           risk: 'high'   },
  'spotxchange.com':          { name: 'SpotX (Magnite)',         category: 'Advertising',           risk: 'high',     desc: 'Video ad serving and programmatic platform' },
  'adsafeprotected.com':      { name: 'Integral Ad Science',     category: 'Advertising',           risk: 'high',     desc: 'Ad verification and viewability tracking' },
  'doubleverify.com':         { name: 'DoubleVerify',            category: 'Advertising',           risk: 'high',     desc: 'Ad verification and measurement' },
  'serving-sys.com':          { name: 'Sizmek (Amazon)',         category: 'Advertising',           risk: 'high',     desc: 'Ad serving and creative optimization' },

  // ── TikTok / ByteDance (additional) ──────────────────────
  'analytics-sg.tiktok.com':  { name: 'TikTok Analytics (SG)',   category: 'Advertising',           risk: 'high'   },
  'mon.tiktokv.com':          { name: 'TikTok Monitoring',       category: 'Advertising',           risk: 'high'   },

  // ── CDP / Customer Data Platforms ────────────────────────
  'cdn.rudderlabs.com':       { name: 'RudderStack',             category: 'Analytics',             risk: 'medium',   desc: 'Open-source customer data pipeline' },
  'mparticle.com':            { name: 'mParticle',               category: 'Data Broker',           risk: 'high',     desc: 'Customer data platform aggregating cross-app behaviour' },
  'cdp.cloud.snowplowanalytics.com': { name: 'Snowplow', category: 'Analytics',          risk: 'medium',   desc: 'Behavioural data collection pipeline' },

  // ── Consent / Tag (often gateway to many trackers) ───────
  'cdn.cookielaw.org':        { name: 'OneTrust',                category: 'Consent Management',    risk: 'low',      desc: 'Consent management platform — gateway for tag loading' },
  'consent.cookiebot.com':    { name: 'Cookiebot',               category: 'Consent Management',    risk: 'low',      desc: 'Consent management and cookie scanning' },
  'quantcast.mgr.consensu.org': { name: 'Quantcast Choice',      category: 'Consent Management',    risk: 'medium',   desc: 'IAB TCF consent management framework' },

  // ── Session Recording (additional) ───────────────────────
  'mouseflow.net':            { name: 'Mouseflow',               category: 'Session Recording',     risk: 'critical' },
  'datadoghq.com':            { name: 'Datadog RUM',             category: 'Session Recording',     risk: 'high',     desc: 'Real user monitoring with session replay' },
  'fullstory.org':            { name: 'FullStory',               category: 'Session Recording',     risk: 'critical' },
};
